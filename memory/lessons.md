...
**Implication:** The 4R fixed take-profit combined with a slow 20-EMA trailing exit lets a +3R unrealized winner round-trip to scratch/small loss. This is the same structural gap as the 2026-04-24 EMA-cross/commission lesson but materially larger — ~3R of open profit surrendered, not just commission drag. Routine #4 should evaluate (a) move-stop-to-breakeven (or partial scale-out) once unrealized ≥ 2R, (b) a faster trailing mechanism past a defined R threshold, or (c) lowering the fixed target from 4R given how rarely it is reached (1 of 17 closed trades inception-to-date). Pair with the 2026-04-24 EMA-cross lesson for a combined exit-logic Ring-2 proposal.
**Score:** _(routine #4 will assign)_
**Status:** active
