...
| IDEA-20260429-03 | 2026-04-29T19:55Z | Glassnode Insights | https://insights.glassnode.com/the-week-onchain-week-17-2026/ | BTC | When 7-day spot CVD on BTC transitions from sustained negative to positive deltas, expect short-term recovery. | Spot CVD is a real-time gauge of buy-vs-sell imbalance; sign-flip indicates exhausted seller initiation. | 4 | 3 | 2 | 9 | raw | **Note 2026-04-29:** held in `raw` pending routine #4 Saturday cost-benefit. CVD via community Pine indicator is feasible but adds integration cost; routine #4 to decide whether it's worth pursuing vs. pure-momentum baseline. Idea remains in bank — not pruned. **REINFORCED 2026-05-12:** Glassnode BTC Market Pulse Week 20 (May 11) cites Spot CVD again as a leading indicator of the $77K→$82K move. Same concept resurfacing in 2 of 2 Glassnode posts in the harvest window strengthens the case for routine #4 to act. |
| IDEA-20260512-01 | 2026-05-12T16:30Z | Glassnode Insights | https://insights.glassnode.com/the-week-onchain-week-18-2026/ | BTC | When the 30-day moving average of US Spot Bitcoin ETF net flows crosses from sustained negative to positive territory, expect a structural BTC tailwind / continuation regime. | 30d MA smooths daily noise; sign-flip captures institutional regime change in spot demand. Glassnode W18 cites this metric as confirming the $66K→$80K recovery; metric publicly available via SoSoValue / Farside (NOT Glassnode-proprietary — testability higher than IDEAs 01/02). | 5 | 4 | 3 | 12 | under-review | **NEW high-fit harvest 2026-05-12.** ETF flow data is publicly fetchable — bypasses the Glassnode data barrier that pruned IDEA-01/02. Could be added as a daily fetch in routine #1 or new routine #8. BTC-only regime filter; affects ~30-40% of BULL's positions (BTC the most-frequent pair). **`under-review` 2026-05-16 (routine #4 W20 memo):** highest-scoring raw row, cited as lead idea-bank candidate. Not yet spun up — needs (a) external SoSoValue/Farside daily fetch wired, (b) backtest (TV unavailable W20). Queued #1 for first TV-enabled harness; user asked in W20 memo whether to wire the feed pre-emptively. |
| IDEA-20260429-04 | 2026-04-29T19:55Z | Glassnode Insights | https://insights.glassnode.com/the-week-onchain-week-17-2026/ | regime | When realized vol and implied vol converge (gap < 2%) on BTC, expect range-bound chop; reduce confidence in momentum entries. | Compressed RV/IV gap = limited directional conviction; momentum strategies underperform in low-vol-spread regimes. | 4 | 4 | 3 | 11 | **under-review** | **2026-04-29: spun up as variant `v0.3-vol-compression`** (RV-only proxy: 1H ATR(14) < 0.5 × 30d-mean ATR rejects entries). See `variants/v0.3-vol-compression/`. Promotion-eligible 2026-05-29 if leaderboard criteria met. |
...
| HARV-20260512-CATCHUP | 2026-05-12T16:30Z manual catch-up | 8 attempted (Hayes, Glassnode, RW, CoinMetrics, Newfound, Woo, CryptoQuant, Alden); 2 source-list issues | 6 | 12 | 1 (+ 1 reinforced) | 0 | 1 | **Manual catch-up — routine #6 was silently failing for 13 days.** Scheduled task fires daily per scheduler (lastRunAt 2026-05-12) but produces no git output on Fridays 05-01 and 05-08 (the two Fridays in window). Pipeline itself works — confirmed by this manual run. Survivors: IDEA-20260512-01 (ETF flows 30d MA sign-flip, score 12, BTC). Reinforced: IDEA-20260429-03 (CVD turn-positive — same concept resurfaced in Glassnode W20). **Source-list maintenance needed:** Lyn Alden URL returns 404 (use `https://www.lynalden.com/`?), Woocharts is a chart page not a blog, Marcos López de Prado (LinkedIn) and Ari Paul (X) require auth — no scrapable feed. Recommend routine #4 Saturday memo proposes idea_sources.md cleanup. |
