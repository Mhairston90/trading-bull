...
> **Last rebuild:** 2026-05-05T20:00:00Z (routine-02-midday 5/5 — 3 OPEN positions held; LINK/BTC/XRP all above 1H 20-EMA on just-closed 19:00Z bar; no exits).
...
- Unrealized PnL: **+$93.29**
  - LINK: 257 × 9.74589 = $2,504.69 MTM; cost 257×9.4393 + comm $6.31 = $2,432.21 → **+$72.48**
  - BTC: 0.0299 × 81683.1 = $2,442.32 MTM; cost 0.0299×80961.16 + comm $6.29 = $2,427.03 → **+$15.29**
  - XRP: 1723 × 1.41544 = $2,438.80 MTM; cost 1723×1.40857 + comm $6.31 = $2,433.28 → **+$5.52**
- Position values (MTM): **$7,385.82**
- Current equity (cash + positions MTM): **$9,806.00**
...
|------|------|------|-------|------|------------|-----------|----------|--------|---------|
| LINK/USD | long | 257 | 9.4393 | 9.2018 | 2026-05-04T19:00Z | 0.2375 | $61.04 | 0.623% | yes (BTC-corr) |
...
Portfolio risk-at-moment: **1.12%** (cap 4%).
...
- Daily realized + unrealized: **+0.96%** today (cap 5%) — combined unrealized +$93.29 vs starting equity baseline $9,712.74 (post-realized)
...
- Max drawdown: 2.21% (cap 25%, warn 12.5%) — clear
- Equity floor: $9,806.00 > $7,500 floor — OK
