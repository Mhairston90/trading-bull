...
> **Last rebuild:** 2026-05-04T19:10:00Z (routine-01-overnight — opened LINK/USD long; broad-rally entry on rule-v0-momentum after 5-day routine gap. Supersedes a 19:05:30Z midday rebuild that ran concurrently and missed this OPEN row).

## Account

- Starting equity: **$10,000.00**
- Cash: **$7,280.49**  *(prev $9,712.70 − LINK notional 257×9.4393 = $2,425.90 − commission 0.26% = $6.31)*
...
- Unrealized PnL: **−$7.51**  *(LINK MTM 257×9.43462 = $2,424.70; cost 257×9.4393 + comm $6.31 = $2,432.21)*
- Position values (MTM): **$2,424.70**
- Current equity (cash + positions MTM): **$9,705.19**
...
|------|------|------|-------|------|------------|-----------|----------|--------|---------|
| LINK/USD | long | 257 | 9.4393 | 9.2018 | 2026-05-04T19:00Z | 0.2375 | $61.03 | 0.63% | yes (BTC-corr) |
...
- Daily realized + unrealized: **−0.08%** today (cap 5%) — LINK entry drag −$7.51 on pre-entry equity $9,712.70
...
- Max drawdown: 3.21% (cap 25%, warn 12.5%) — clear
- Equity floor: $9,705.19 > $7,500 floor — OK
