...
- **CORRECTION NOTE (2026-06-12 22:00 PT):** Prior entry used stale BTC close $62,590 and incorrectly concluded "all 15 pairs fail rule 3." Corrected close $63,430.6 > 50-EMA ~$63,013 → BTC PASSES rule 3. However, the 0.7× vol-comp gate blocks harder than v0.3 (threshold 0.7×$412 = $288 vs current ATR $391.5 — still blocks). 0-entry conclusion unchanged.
